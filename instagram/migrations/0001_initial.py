# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-05-19 13:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_date', models.DateTimeField(auto_now_add=True)),
                ('comments', models.ManyToManyField(to='instagram.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='Likes',
        ...
        migrations.AddField(
            model_name='image',
            name='likes',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='instagram.Likes'),
        ),
        migrations.AddField(
            model_name='image',
            name='profile',
